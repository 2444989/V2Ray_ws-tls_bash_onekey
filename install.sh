...
web_camouflage(){
    ...
    git clone https://github.com/2444989/sCalc.git
    judge "web 站点伪装"   
}
v2ray_install(){
...
v2ray_conf_add(){
    cd /etc/v2ray
    wget https://raw.githubusercontent.com/2444989/V2Ray_ws-tls_bash_onekey/master/tls/config.json -O config.json
modify_port_UUID
judge "V2ray 配置修改"
}
nginx_conf_add(){
